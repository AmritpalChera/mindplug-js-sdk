...
export default class Mindplug {
  ...
  async generateTweet(text: string, tone?: string) {
    return this.mindplug.post('/smart/generateTweet', {text, tone}).then((res: any) => res.data).catch((err: any) => err.response.data);
  }
}
